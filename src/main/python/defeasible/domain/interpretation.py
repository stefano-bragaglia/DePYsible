...
class DialecticalTree:
    ...
    def is_acceptable(self, defeater: Structure, disagreement: Structure) -> bool:
        ...
        #     return False
        #
        # return self._is_not_chain_or_defeated(defeater, disagreement)
...
if __name__ == '__main__':
    ...
    #             disagreement = defeaters[argument][dtype][counter_argument]
    #             print(dtype, counter_argument, '\t', argument, '\t', disagreement)
    # print('-' * 120)
    ...
    query(Literal.parse('~nests_in_trees(tina)'))
    query(Literal.parse('nests_in_trees(tweety)'))
    query(Literal.parse('~nests_in_trees(tweety)'))
